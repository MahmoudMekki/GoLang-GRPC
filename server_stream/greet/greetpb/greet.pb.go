...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	0xd8, 0xa2, 0xc4, 0x60, 0xc0, 0xe8, 0xc4, 0x19, 0x05, 0x0b, 0x92, 0x24, 0x36, 0x70, 0x10, 0x19,
	0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xdb, 0xb1, 0x39, 0x50, 0x3f, 0x01, 0x00, 0x00,
}
...
type GreetServiceClient interface {
	Greet(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (GreetService_GreetClient, error)
}
...
func (c *greetServiceClient) Greet(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (GreetService_GreetClient, error) {
...
func (x *greetServiceGreetClient) Recv() (*GreetingResponse, error) {
...
type GreetServiceServer interface {
	Greet(*GreetingRequest, GreetService_GreetServer) error
}
...
func (*UnimplementedGreetServiceServer) Greet(req *GreetingRequest, srv GreetService_GreetServer) error {
...
func (x *greetServiceGreetServer) Send(m *GreetingResponse) error {
